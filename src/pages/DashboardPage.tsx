...
import { ArrowUpCircle, ArrowDownCircle, Wallet, Activity, PlusCircle, AlertCircle } from "lucide-react";
...
export function DashboardPage() {
  ...
  // Limita para 7 categorias, agrupa o resto em "Outros"
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between mb-2">
        <div>
          <h1 className="text-xl font-bold text-slate-800 tracking-tight uppercase">Bom dia, Administrador!</h1>
        ...
        <div className="flex flex-wrap gap-2 items-center">
          ...
          {/* Botão Nova Transação sempre visível, desabilitado se ALL */}
          <button
      ...
      {loading ? (
        ...
        <>
          ...
          <Card className="shadow-sm border-slate-200">
            <CardHeader className="border-b border-slate-100 pb-4 mb-4">
              <CardTitle className="text-slate-800 text-lg font-semibold">Todas as Transações</CardTitle>
              <CardDescription className="text-slate-500">
                Lista completa de transações no período selecionado ({filteredTransactions.length} registros)
              </CardDescription>
            </CardHeader>
            <CardContent>
              <TransactionTable
